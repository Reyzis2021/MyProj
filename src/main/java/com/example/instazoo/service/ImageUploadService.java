...
import com.example.instazoo.exceptions.ImageMotFoundException;
...
public class ImageUploadService {
    ...
    @Autowired
    public ImageUploadService(UserRepository userRepository, PostRepository postRepository, ImageRepository imageRepository) {
    ...
    public ImageModel getImageToUser(Long postId){
        ImageModel imageModel = imageRepository.findByPostId(postId).orElseThrow(
                () -> new ImageMotFoundException("Cannot find image by post ID" + postId));
    ...
    private byte[] compressBytes (byte [] data){
        ...
        System.out.println("Compress Image Byte Size - "
